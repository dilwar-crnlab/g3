...
class OpticalNetworkEnv(gym.Env):
    ...
    def __init__(self, topology=None, episode_length=100, load=100, mean_service_holding_time=10,
                 num_spectrum_resources=916, allow_rejection=False,
    ...
    def _get_node_pair(self):
        ...
        """
        src = self.rng.choices([x for x in self.topology.nodes()], weights=self.node_request_probabilities)[0] #Escoge aleatoriamente un nodo, si se le pasa probabilidad la tiene en cuenta, sino genera trafico uniforme.
